...
const app = express();
app.use(cors({
    origin: ['http://localhost:5173', 'http://localhost:5174', 'http://localhost:5175', 'https://e-commerce-8uvd.vercel.app', 'http://sparknstitch.com','https://www.sparknstitch.com', 'https://www.sparknstitch.com/'],
    credentials: true
  }));
app.options('*', cors())
